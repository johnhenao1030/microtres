...
const Text = (props) => {
    ...
    const propsAsString = JSON.stringify(props, null, 2); // El segundo argumento `null` y el tercero `2` son para formatear el JSON

    return (
        <div>
            <p>Bienvenido al microfrontend tres</p>
